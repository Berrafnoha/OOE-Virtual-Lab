...
### 🌊 [Track 1: Caustic Wave Patterns](./Track-4-Caustics/)
* **Physics:** Study of light ray envelopes formed by reflection/refraction through curved boundaries (Caustics).
...
To run the Antenna Leakage or Python-based simulations:
